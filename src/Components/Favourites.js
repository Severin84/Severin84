              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><i class="fa-solid fa-caret-up" onClick={this.sortPopularityDesc}></i>Popularity<i class="fa-solid fa-sort-down" onClick={this.sortPopularityAsc}></i></th>
